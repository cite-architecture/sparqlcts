...
*/
    ...
    void testVersionResolve() {
        ...
        String expectedVersion = "urn:cts:greekLit:tlg0012.tlg001.chs01:1.1"
    ...
    void testContainerResolve() {
        ...
        assert expectedContainer == ctsg.getWorkHierarchyContainer(new CtsUrn("urn:cts:greekLit:tlg0012.tlg001.chs01:1.1"))
    }
    ...
    void testGetSeq() {
        CtsUrn iliadline1 = new CtsUrn("urn:cts:greekLit:tlg0012.tlg001.chs01:1.1")
        assert ctsg.getSequence(iliadline1) == 1

        // getSequence method requires leaf-node URN:
        CtsUrn iliadbook1 = new CtsUrn("urn:cts:greekLit:tlg0012.tlg001.chs01:1")
        assert shouldFail {
